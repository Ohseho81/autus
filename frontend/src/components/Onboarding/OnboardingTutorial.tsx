...
const TUTORIAL_STEPS: TutorialStep[] = [
  {
    id: 'welcome',
    title: '🎉 온리쌤에 오신 것을 환영합니다!',
    description: '온리쌤은 당신의 삶을 9개 영역으로 나누어 관리하는 개인 AI 운영체제입니다. 간단한 튜토리얼로 사용법을 알아볼까요?',
  ...
  },
  {
    id: 'complete',
    title: '✅ 준비 완료!',
    description: '이제 온리쌤이 당신의 흐름을 관찰할 준비가 되었습니다. 궁금한 점이 있으면 언제든 도움말을 확인할 수 있습니다.',
