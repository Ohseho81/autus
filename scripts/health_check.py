...
class AutusHealthCheck:
    ...
    def check_constitution(self):
        ...
        code, output = self.run_cmd(f"{self.venv_python} packs/security/constitution_validator.py 2>&1")
        self.add_result("constitution", "Article II: Privacy (No PII)", "passed" in output.lower(), output[-80:])
        
        # Article III: Meta-Circular
        meta_exists = (self.root / "scripts/meta_circular.py").exists()
    ...
    def check_core(self):
        ...
        modules = [
            ...
            ("Meta-Circular", "scripts/meta_circular.py", "core.meta_circular"),
            ("Constitution Validator", "packs/security/constitution_validator.py", "core.constitution_validator"),
        ]
