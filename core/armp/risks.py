...
# ═══════════════════════════════════════════
# Risk 1: PII 저장 시도 (Article II 위반)
# ═══════════════════════════════════════════
...
def respond_to_pii():
    """PII 대응"""
    logger.critical("🚨 CONSTITUTION VIOLATION: PII detected in storage")
...
# ═══════════════════════════════════════════
# Risk 2: Code Injection (Article II 위반)
# ═══════════════════════════════════════════
...
# ═══════════════════════════════════════════
# Risk 3: API Rate Limit (Article IV 위반)
# ═══════════════════════════════════════════
...
# ═══════════════════════════════════════════
# Risk 4: Database Corruption (Article IV 위반)
# ═══════════════════════════════════════════
...
# ═══════════════════════════════════════════
# Risk 5: Performance Budget Exceeded (Article IV 위반)
# ═══════════════════════════════════════════
...
def respond_to_performance_violation():
    """성능 예산 위반 대응"""
    logger.warning("⚠️ Performance budget exceeded: Enabling resource limits")
    # 리소스 제한 활성화
    # 불필요한 프로세스 종료
...
performance_risk = Risk(
    ...
    prevention=prevent_performance_violation,
    detection=detect_performance_violation,
    response=respond_to_performance_violation,
    recovery=recover_from_performance_violation
)
