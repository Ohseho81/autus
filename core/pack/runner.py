...
class DevPackRunner:
    ...
    def __init__(self, api_key: str = None):
        ...
        Args:
            api_key: Anthropic API 키 (없으면 환경변수에서)
        """
    ...
    def load_pack(self, pack_name: str) -> Dict[str, Any]:
        ...
        Args:
            pack_name: Pack 이름 (예: dev_architect)
    ...
    def execute_cell(
        ...
        # Claude API 호출
        print(f"🤖 Calling Claude API for cell: {cell_name}")
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        print("Usage: python dev_runner.py <pack_name> [inputs_json]")
        sys.exit(1)
